...
const FaqPage = () => {
  return (
    ...
    <Spacer>
      <H3>Why do people go to therapy and how do I know if it is right for me?</H3>
    ...
    <Spacer>
      ...
      <Paragraph>Because each person has different issues and goals for therapy, therapy will be different depending on the individual, in general, you can expect to discuss the current events happening in your life, your personal history relevant to your issue, and report progress (or any new insights gained) from the previous therapy session. Depending on your specific needs, therapy can be short-term, for a specific issue, or longer-term , to deal with more difficult patterns or your desire for more personal development. Either way, it is most common to schedule regular sessions with your therapist (usually weekly).</Paragraph>

      <Paragraph>It is important to understand that you will get more results from therapy if you actively participate in the process. The ultimate purpose of therapy is to help you bring what you learn in session back to your life. Therefore, beyond the work you do such as reading a pertinent book, journaling on specific topics, noting particular behaviors or taking action on your goals. People seeking psychotherapy are ready to make positive changes to their lives and are open to new perspectives and take responsibility for their lives.</Paragraph>
    </Spacer>

    <Spacer>
      <H3>What about medications vs. psychotherapy?</H3>
      <Paragraph>It is well established that the long-term solution to mental and emotional problems and the pain they cause cannot be solved solely by medication. Instead of just treating the symptom, therapy addresses the cause of our distress and the behavior patterns that curb our progress. You can best achieve sustainable growth and a greater sense of well-being with an integrative approach to wellness. Working with your medical doctor you can determine what's best for you, and in some cases a combination of medication and therapy is the right course of action.</Paragraph>
    </Spacer>

    ​
    <Spacer>
      <H3>Do you take insurance, and how does that work?</H3>
      <Paragraph>To determine if you have mental health coverage through your insurance carrier, the first thing you should do is call them. Check your coverage carefully and make sure you understand their answers. Some helpful questions you can ask them are:</Paragraph>
    ...
    <Spacer>
      ...
      <Paragraph>Confidentiality is one of the most important components between a client and psychotherapist. Successful therapy requires a high degree of trust with highly sensitive subject matter that is usually not discussed anywhere but the therapists office. Every therapist should provide a written copy of their confidential disclosure agreement, and you can expect that what you discuss in session will not be shared with anyone. This is called “informed consent”. Sometimes, however, you may want your therapist to share information or give an update to someone on your health care team (your physician, naturalist, attorney) but by law your therapist cannot release this information without obtaining you written permission.</Paragraph>

      <Paragraph>However, state law and professional ethics require therapists to maintain confidentially except for the following situations:</Paragraph>
